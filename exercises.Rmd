...
El peso de 71 gallinas fue medido en kilogramos. He aquí una parte de los datos:

```{r echo=FALSE, results = 'asis'}
kable_styling(kable(data.frame(Kg=head(chickwts$weight,10))),"striped", position = "left")
```
