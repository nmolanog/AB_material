...
Esta regla se puede deducir de la formula \@ref(eq:A4). Notese que $A\cup B = (A|B) \cup (A\cap B) \cup (B|A)$ en donde $A|B$ es el conjunto de los elementos que estan en $A$ pero no en $B$. En notacion de teoria de conjuntos seria $A|B=\{x \in U | x \in A \; y  \, x \notin B\}$, tambien puede demostrarse que $A|B= A \cap B^c$. ver figura \@ref(fig:A5image). 
...
$$=\frac{200}{1000}+\frac{201}{1000}+\frac{21}{1000}$$
