...
```{r fdpoisr2, echo=FALSE, results = 'asis',fig.width=7, fig.height=4, fig.cap="Funcion de densidad para diferentes valores del parametro"}
xrange<-0:50
...
dtf_pois2%>%ggplot(aes(x=x,y=y,color=parameter))+geom_point()+
  ylab("f(x)")+ theme_bw()+ labs(color = expression(lambda),
