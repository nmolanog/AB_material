...
En el contesto del estudio de metformina + glibenclamida, se quiere calcular un tamaño de muestra bajo los siguientes supuestos:

* La varianza de la desviación estándar de la diferencia se encuentra al rededor de 15 unidades.
...
Con esta información el estadístico del proyecto a producido el siguiente gráfico:
...
En el gráfico se presenta la potencia en función del tamaño de la muestra. A continuación mostramos algunos valores exactos para potencias al rededor de 0.8:
