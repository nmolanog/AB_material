...
El tamaño de la muestra $n$, El nivel de confianza (es decir $1-\alpha$) y la desviación estándar de los datos $S$. A continuación exploraremos el efecto de cada una de estas cantidades sobre la amplitud del intervalo.
