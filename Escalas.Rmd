...
En un laboratorio, el tecnico debe prepara una prueba diagnostica y en el protocolo de esta prueban el tecnico debe medir 30mgr de peroxido de potasio. El tecnico dispone de 4 vasculas (A, B, C y D) y por instrucciones del director del laboratorio, le ha pedido que mida 10 veces el peso rewuerido en cada las basculas. A continuacion se presentan los resultados:

```{r pdtab, echo=FALSE}
###see http://haozhu233.github.io/kableExtra/awesome_table_in_html.html
z0<-data.frame(A=rnorm(10,30,3),B=rnorm(10,30,9),C=rnorm(10,25,3),D=rnorm(10,25,9))
